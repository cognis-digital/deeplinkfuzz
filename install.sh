#!/usr/bin/env sh
# Universal installer for deeplinkfuzz. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/deeplinkfuzz.git"
echo "Installing deeplinkfuzz ..."
...
echo "Done. Run: deeplinkfuzz --help"
